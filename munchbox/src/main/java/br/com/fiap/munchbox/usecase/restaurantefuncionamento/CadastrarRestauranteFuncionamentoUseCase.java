...
@Component
public class CadastrarRestauranteFuncionamentoUseCase
{
    private final RestauranteFuncionamentoGateway restauranteFuncionamentoGateway;

    public CadastrarRestauranteFuncionamentoUseCase(RestauranteFuncionamentoGateway restauranteFuncionamentoGateway)
    {
    ...
    {
        this.restauranteFuncionamentoGateway.create(restauranteFuncionamento);
    }
}
