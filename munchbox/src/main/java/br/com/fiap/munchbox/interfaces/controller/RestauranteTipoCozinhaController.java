...
public class RestauranteTipoCozinhaController {
    ...
    public RestauranteTipoCozinhaController(CadastrarRestauranteTipoCozinhaUseCase cadastrarRestauranteTipoCozinhaUseCase,
    ...
    public ResponseEntity<RestauranteTipoCozinha> create(
        ...
        logger.info("Tipo de cozinha de restaurante cadastrado com sucesso: {}", restauranteTipoCozinha.getNome());
    ...
    public ResponseEntity<RestauranteTipoCozinha> update(
            @RequestBody RestauranteTipoCozinhaRequestDTO restauranteTipoCozinhaRequestDTO, @PathVariable Long id) {
        logger.info("Iniciando atualização do tipo de cozinha de restaurante com ID: {}", id);
        ...
        logger.info("Tipo de cozinha de restaurante atualizado com sucesso: {}", restauranteTipoCozinha.getNome());
    ...
    public ResponseEntity<Void> delete(@PathVariable("id") Long id) {
        logger.info("Iniciando remoção do tipo de cozinha de restaurante com ID: {}", id);

        removerRestauranteTipoCozinhaUseCase.execute(id);

        logger.info("Tipo de cozinha de restaurante removido com sucesso: {}", id);
    ...
    public ResponseEntity<List<RestauranteTipoCozinha>> findAll(
        ...
        List<RestauranteTipoCozinha> restauranteTipoCozinhas = consultarTodosRestauranteTipoCozinhaUseCase.execute(
                pageable);

        logger.info(
                "Consulta de todos os tipos de cozinha de restaurante concluída. Total de tipos de cozinha de restaurante encontrados: {}",
    ...
    public ResponseEntity<Optional<RestauranteTipoCozinha>> findById(@PathVariable Long id) {
        logger.info("Iniciando consulta do tipo de cozinha de restaurante com ID: {}", id);
        ...
        if (restauranteTipoCozinha.isPresent()) {
            logger.info("Tipo de cozinha de restaurante encontrado: {}", restauranteTipoCozinha.get().getNome());
        }
        else {
            logger.warn("tipo de cozinha de restaurante com ID {} não encontrado", id);
        }
